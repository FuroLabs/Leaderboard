  ...
  return (
    <main className="min-h-screen font-sans bg-[var(--background)] text-[var(--foreground)]">
        ...
        <div className="flex flex-col items-end justify-between md:flex-row gap-6">
          <div className="w-full md:w-1/2">
            ...
            <p className="mb-2">
              ...
              <strong className="text-[var(--link-color)]">Furo Labs</strong>.
            </p>
            <p className="mb-6">
              Want to be featured? Contribute to our{" "}
              <a
                href="https://github.com/FuroLabs/"
            ...
            <p className="md:block hidden">
              ...
              <a
                href="https://github.com/FuroLabs/leaderboard/blob/main/src/utils/scoring.ts"
                className="hover:underline font-medium text-[var(--link-color)]"
                target="_blank"
      ...
      <section className="w-full text-center py-6 text-sm text-gray-500">
        © {new Date().getFullYear()} Furo Labs. Made with{" "}
        <span className="text-red-500">❤️</span> by the Furo Labs team
      </section>
    </main>
  )
}
